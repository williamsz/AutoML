...
func_names = [{0:'log1p',1:'QuantileTransformer'}, {0:'StdScaler',1:'RbtScaler',2:'MinMaxScaler'},
...
def main(args):
	...
	# scores_randomforest = randomforest(dataset)
	...
	# scores_rl = trnr.train_controller()
	# print(scores_rl)
	...
	result_map = {'AutoSklearn':scores_autosklearn}
	df = pd.DataFrame(data=result_map)
	path = os.path.join(args.model_dir, 'AutoSklearn.csv')
	df.to_csv(path)
